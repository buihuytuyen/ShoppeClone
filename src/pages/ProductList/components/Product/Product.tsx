      ...
      <div className='bg-white shadow rounded-sm overflow-hidden hover:translate-y-[-0.04rem] hover:shadow-md duration-200 transition-transform'>
        ...
        <div className='p-2 overflow-hidden'>
          <div className='min-h-[2rem] line-clamp-2 text-xs'>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Temporibus nihil magni distinctio tempora, quod
            voluptatem adipisci quibusdam? Fugiat magni dicta ratione iste illum, deserunt tenetur impedit beatae
            obcaecati, veritatis pariatur.
          </div>
